...
export const works = [
  ...
  },
  {
    slug: "tvshows",
    icon: "T",
    heroImage: "/bgtvshow.png",
    gradient: [colors.pinkSoft, colors.blueSoft],
    type: "Category 04",
    title: "รายการ\nทีวี",
    desc: "รายการทีวี · เกมโชว์ · วาไรตี้ · และรายการพิเศษ",
    items: [
      { name: "ไมค์หมดหนี้", year: "" },
      { name: "ร้องข้ามกำแพง", year: "" },
      { name: "ศึก 12 ราศี", year: "" },
    ],
    color: colors.pink,
    detail: {
      headline: "รายการทีวี",
      sub: "รายการทีวี · เกมโชว์ · วาไรตี้",
      body: "รวมรายการทีวีและวาไรตี้ที่ Tee Jaruji ร่วมรายการ",
      items: [],
    },
  },
];
...
export const collabs = [
  {
    ...
    color: '#E30613',
    video:  'https://pub-46fa3f6d65804c9ea240d7ff9b16d7bc.r2.dev/CMG%20Tee%20Master%20%5B16-9%5D.mp4',
  ...
  },
  {
    ...
    color: '#5B7FA6',
    logoStyle: {},
    video:  'https://pub-46fa3f6d65804c9ea240d7ff9b16d7bc.r2.dev/CurelxTee%20D5.mp4',
