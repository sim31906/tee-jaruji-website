export const translations = {
  th: {
      ...
      workDetail: [
        {
          ...
          items: [
            { name: 'AROI FEST', year: '2569', detail: 'มินิคอนเสิร์ต · เซ็นทรัล เชียงใหม่ แอร์พอร์ต' },
            { name: 'Zero Nicotine Fest', year: '2569', detail: 'วันงดสูบบุหรีโลก · AstraZeneca × จุฬาฯ' },
            { name: 'Zero Waste at The SEA', year: '2569', detail: 'จิตอาสาเก็บขยะชายหาด · ช่อง 3 อาสาทำดี' },
    ...
    fanclub: {
      ...
      services: [
        ...
        },
        {
          num: 'iii.',
          title: "Tee's Room\nOpen Chat",
          desc: 'ห้อง Line Open Chat เพื่อความใกล้ชิดของศิลปินกับแฟนคลับ และเป็นพื้นที่เติมพลังความสุขให้กันและกัน',
          arrow: 'เข้าร่วมห้อง →',
          url: 'https://t.co/MsqUyWzcxi',
        },
      ],
    ...
    performance: {
      backNav: '← กลับหน้าหลัก',
      categoryLabel: 'การแสดงและภาพยนตร์',
      titleMain: 'การแสดง &',
      titleItalic: 'ภาพยนตร์',
      subtitle: 'ผลงานการแสดงของ Tee Jaruji ทั้งซีรีส์และภาพยนตร์ — กดที่การ์ดเพื่อดูเรื่องย่อ ตัวอย่าง และช่องทางรับชม',
      allWorks: '— ผลงานทั้งหมด',
      itemsUnit: 'รายการ',
      backButton: '← กลับไป ผลงานที่คัดสรร',
      ...
      typeSeries: 'ซีรีส์',
      typeMovie: 'ภาพยนตร์',
      typeVariety: 'ท่องเที่ยว',
      modalCategory: 'Category 02',
      watchOn: 'ดูได้ที่',
      trailerLabel: '— ตัวอย่าง / Trailer',
      summaryLabel: '— เรื่องย่อ',
      synopsisLabel: '— Synopsis',
      noTrailer: 'ยังไม่มีตัวอย่าง',
      posterAlt: 'poster',
    },
    music: {
      backNav: '← กลับหน้าหลัก',
      categoryLabel: 'เพลงและดนตรี',
      titleMain: 'เพลงและ',
      titleItalic: 'ดนตรี',
      subtitle: 'ผลงานเพลงและดนตรีของ Tee Jaruji',
      teeSongTitle: 'เพลงของ Tee',
      teeSongSub: 'เพลงที่ Tee Jaruji ร้อง / ร่วมร้อง — กดการ์ดเพื่อดูเนื้อเพลงและลิงก์',
      mvTitle: 'MV ที่มี Tee ร่วม',
      mvSub: 'Music Video ที่ Tee Jaruji ร่วมร้องเพลงหรือร่วมแสดง',
      listenOn: 'ฟังได้ที่',
      lyrics: 'เนื้อเพลง',
    ...
    timeline: {
      ...
      filterAll: 'ทั้งหมด',
      viewTimeline: 'ดูการเดินทาง →',
      tapToView: 'กดดูรายละเอียด →',
      scrollHint: 'เลื่อนเพื่อเริ่มการเดินทาง',
      goToStart: '↑ ไปจุดเริ่มต้น',
      progressStart: '2554',
      progressEnd: 'ปัจจุบัน',
      checkpointAdd: 'เพิ่ม checkpoint',
      checkpointRemove: 'ลบ checkpoint',
      checkpointHint: 'กด ◇ เพื่อ mark',
  ...
  en: {
      ...
      workDetail: [
        {
          ...
          items: [
            { name: 'AROI FEST', year: '2026', detail: 'Mini Concert · Central Chiangmai Airport' },
            { name: 'Zero Nicotine Fest', year: '2026', detail: 'World No Tobacco Day · AstraZeneca × Chulalongkorn' },
            { name: 'Zero Waste at The SEA', year: '2026', detail: 'Beach Cleanup · Channel 3 Volunteer' },
    ...
    fanclub: {
      ...
      services: [
        ...
        },
        {
          num: 'iii.',
          title: "Tee's Room\nOpen Chat",
          desc: 'A LINE Open Chat room for closeness between Tee and his fans — a warm space to share joy and recharge together.',
          arrow: 'Join the room →',
          url: 'https://t.co/MsqUyWzcxi',
        },
      ],
    ...
    performance: {
      backNav: '← Back to Home',
      categoryLabel: 'Performance & Acting',
      titleMain: 'Performance &',
      titleItalic: 'Acting',
      subtitle: "Tee Jaruji's acting works — click any card to view synopsis, trailer, and where to watch.",
      allWorks: '— All Works',
      itemsUnit: 'items',
      backButton: '← Back to Selected Works',
    ...
    music: {
      ...
      titleMain: 'Music &',
      titleItalic: 'Sound',
      subtitle: 'Music releases · Singles · OST · Live performances of Tee Jaruji',
      teeSongTitle: "Tee's Songs",
      teeSongSub: 'Songs sung / co-sung by Tee Jaruji — click a card to view lyrics and links',
      mvTitle: 'MVs featuring Tee',
      mvSub: 'Music Videos featuring Tee Jaruji — as a vocalist or as an actor',
      listenOn: 'Listen on',
      lyrics: 'Lyrics',
    ...
    timeline: {
      ...
      checkpointRemove: 'Remove checkpoint',
      checkpointHint: 'click ◇ to mark',
      checkpointDone: 'checkpoint ✓',
      itemsUnit: 'items',
      yearPrefix: 'Year',
    },
  ...
  zh: {
      ...
      workDetail: [
        {
          ...
          items: [
            { name: 'AROI FEST', year: '2026', detail: '迷你演唱会 · 清迈机场中央百货' },
            { name: 'Zero Nicotine Fest', year: '2026', detail: '世界无烟日 · AstraZeneca × 朱拉隆功大学' },
            { name: 'Zero Waste at The SEA', year: '2026', detail: '海滩清洁志愿活动 · 泰国三台' },
    ...
    fanclub: {
      ...
      services: [
        ...
        },
        {
          num: 'iii.',
          title: "Tee's Room\nOpen Chat",
          desc: 'LINE Open Chat 聊天室，拉近 Tee 与粉丝的距离，打造一个互相分享快乐、相互给予力量的温馨空间。',
          arrow: '加入聊天室 →',
          url: 'https://t.co/MsqUyWzcxi',
        },
      ],
    ...
    performance: {
      ...
      titleMain: '表演与',
      titleItalic: '影视',
      subtitle: 'Tee Jaruji 的影视作品 — 点击卡片查看剧情简介、预告片及观看渠道。',
      allWorks: '— 全部作品',
      itemsUnit: '项',
      backButton: '← 返回精选作品',
      viewDetail: '查看详情 →',
    ...
    music: {
      ...
      titleMain: '音乐与',
      titleItalic: '声音',
      subtitle: '音乐发行 · 单曲 · 原声带 · Tee Jaruji 的现场演出',
      teeSongTitle: 'Tee 的歌曲',
      teeSongSub: 'Tee Jaruji 演唱 / 合唱的歌曲 — 点击卡片查看歌词和链接',
      mvTitle: '有 Tee 参与的 MV',
      mvSub: 'Tee Jaruji 以歌手或演员身份参与的音乐视频',
      listenOn: '收听平台',
      lyrics: '歌词',
      backButton: '← 返回主页',
    },
    timeline: {
      ...
      progressEnd: '至今',
      checkpointAdd: '添加标记',
      checkpointRemove: '移除标记',
      checkpointHint: '点击 ◇ 标记',
      checkpointDone: '已标记 ✓',
      itemsUnit: '项',
      yearPrefix: '公元',
    },
