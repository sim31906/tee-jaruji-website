export const translations = {
  th: {
    ...
    profile: {
      ...
      works: [
        { title: 'Event\nAppearances', desc: 'งานเปิดตัว · งานแฟนมีต · งานพรีเซนเตอร์ · กิจกรรมพิเศษทั้งในประเทศและต่างประเทศ' },
        { title: 'Performance\n& Acting', desc: 'งานแสดงละคร · ซีรีส์ · ภาพยนตร์ · และการแสดงบนเวที' },
        { title: 'Music\n& Sound', desc: 'ผลงานเพลง · ซิงเกิล · OST · และการแสดงดนตรีสด' },
      ],
      workDetail: [
        {
    ...
    contact: {
      ...
      items: [
        ...
        { label: 'Line Official', value: '@teejaruji', action: 'เพิ่มเพื่อน' },
    ...
    schedule: {
      ...
      events: [
        { day: '15', month: 'พ.ค.', title: 'Fan Meeting', detail: 'Bangkok · 18:00' },
        { day: '22', month: 'พ.ค.', title: 'Brand Event', detail: 'Siam Paragon · 14:00' },
        { day: '03', month: 'มิ.ย.', title: 'Concert', detail: 'Impact Arena · 19:00' },
      ],
    },
    supporters: {
    ...
    workDetail: {
      ...
      backButton: '← กลับไป Selected Works',
      allWorks: '— All Works',
    },
  },
