export const translations = {
  th: {
    ...
    music: {
      ...
      mvTitle: 'MV ที่มี Tee ร่วมแสดง',
      mvSub: 'Music Video ที่ Tee Jaruji ร่วมแสดงในฐานะนักแสดงประกอบ',
      listenOn: 'ฟังได้ที่',
      lyrics: 'เนื้อเพลง',
  ...
  en: {
    ...
    music: {
      ...
      mvSub: 'Music Videos featuring Tee Jaruji as an actor',
      listenOn: 'Listen on',
      lyrics: 'Lyrics',
  ...
  zh: {
    ...
    music: {
      ...
      mvTitle: '有 Tee 出演的 MV',
      mvSub: 'Tee Jaruji 以演员身份出演的音乐视频',
      listenOn: '收听平台',
      lyrics: '歌词',
      backButton: '← 返回主页',
    },
